...
use pocketmine\entity\ai\goal\enderman\FreezeWhenLookedAt;
use pocketmine\entity\ai\goal\enderman\LeaveBlockGoal;
use pocketmine\entity\ai\goal\enderman\LookForStaringPlayerGoal;
use pocketmine\entity\ai\goal\enderman\TakeBlockGoal;
...
use pocketmine\entity\ai\goal\RandomTeleportGoal;
...
use pocketmine\world\particle\TeleportTrailParticle;
use pocketmine\world\sound\EndermanTeleportSound;
use pocketmine\world\sound\EntityStareSound;
...
class Enderman extends Monster implements NeutralMob{
	...
	public function isLookingAtMe(Living $entity) : bool{
		...
		return $dotProduct > (1 - (0.025 / $distance)) && $this->canSee($entity);
	}
	...
	public function placeBlock(Vector3 $pos) : bool{
		...
		if(!$block->place($tx, $block->asItem(), $blockReplace, $blockBelow, $face, $clickVector)){
			return false;
		}
