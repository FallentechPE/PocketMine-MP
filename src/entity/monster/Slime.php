...
use Closure;
use pocketmine\data\bedrock\SlimeTypeIdMap;
use pocketmine\entity\ai\goal\slime\SlimeAttackGoal;
use pocketmine\entity\ai\goal\slime\SlimeFloatGoal;
use pocketmine\entity\ai\goal\slime\SlimeKeepOnJumpingGoal;
use pocketmine\entity\ai\goal\slime\SlimeRandomDirectionGoal;
use pocketmine\entity\ai\goal\target\NearestAttackableGoal;
use pocketmine\entity\EntitySizeInfo;
use pocketmine\entity\Living;
use pocketmine\entity\Mob;
use pocketmine\entity\MobCategory;
use pocketmine\entity\monster\slime\SlimeMoveControl;
...
class Slime extends Mob implements Enemy {
	...
	public function getMoveControl() : SlimeMoveControl{
		/** @var SlimeMoveControl $moveControl */
