...
class Player extends Human implements CommandSender, ChunkListener, IPlayer{
	...
	public function getSaveData() : CompoundTag{
		...
		if ($this->deathPosition !== null) {
			...
			$nbt->removeTag(self::TAG_DEATH_WORLD, self::TAG_DEATH_X, self::TAG_DEATH_Y, self::TAG_DEATH_Z); // todo This is redundant. The NBT is freshly created, so it won't have these tags anyway.
		}
