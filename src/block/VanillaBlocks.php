...
final class VanillaBlocks{
	...
	protected static function setup() : void{
		...
		self::register("powder_snow", new PowderSnow(new BID(Ids::POWDER_SNOW), "Powder Snow Block", new Info(BreakInfo::shovel(0.2, ToolTier::WOOD()))));		self::register("soul_sand", new SoulSand(new BID(Ids::SOUL_SAND), "Soul Sand", new Info(BreakInfo::shovel(0.5))));
